...
class WorkOrder(models.Model):
    ...
    l1_submission_date = models.DateField(null=True, blank=True)
    ...
    auditor1_l1 = models.CharField(max_length=100, blank=True)
    auditor2_l1 = models.CharField(max_length=100, blank=True)
    high_l1 = models.IntegerField(default=0)
    medium_l1 = models.IntegerField(default=0)
    low_l1 = models.IntegerField(default=0)

    l1_verified_by = models.CharField(max_length=255, blank=True)
    ...
    auditor1_l2 = models.CharField(max_length=100, blank=True)
    auditor2_l2 = models.CharField(max_length=100, blank=True)
    high_l2 = models.IntegerField(default=0)
    medium_l2 = models.IntegerField(default=0)
    low_l2 = models.IntegerField(default=0)
    l2_verified_by = models.CharField(max_length=255, blank=True)
    ...
    auditor1_final = models.CharField(max_length=100, blank=True)
    auditor2_final = models.CharField(max_length=100, blank=True)
    ...
    final_verified_by = models.CharField(max_length=255, blank=True)
    final_report_sent = models.BooleanField(default=False)

    safe_to_host_verified_by = models.CharField(max_length=255, blank=True)
